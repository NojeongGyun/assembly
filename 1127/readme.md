...
<b>ESI</b> -
ESI는 원본 메모리 주소를 가리키는 레지스터입니다. 목적은 읽어오는 위치를 가리킬 떄 사용합니다.

<b>EDI</b> -
EDI는 목적지 메모리 주소를 가리키는 레지스터입니다. 목적은 쓰는 위치를 가리킬 떄 사용합니다.
...
ex) ESI = 1000 // 1000부터 1004까지 "HELLO"라는 문자가 있다고 가정    
