...
플래그 레지스터는 하나의 명령어를 종료하기 위해 연산 결과나 상태를 플래그 레지스터에 보고 후 저장 하는 레지스터를 의미합니다. 이 기록을 바탕으로 조건 분기, 산술 연산 결과 처리, 인터럽트 제어 등 수행합니다. <a herf: https://github.com/NojeongGyun/assembly/tree/main/0918> 플래그 레지스터 종류</a>
